...
export function StoreItemClient({ itemId, paymentMethods }: StoreItemClientProps) {
  ...
  if (isLoading) {
    return (
      <div className="space-y-4">
        <div className="w-32">
          <Link href="/store/items" className="flex items-center text-muted-foreground hover:text-foreground">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="overflow-hidden">
          <div className="aspect-square w-full relative bg-slate-100">
            ...
            {item.category_name && (
              <Badge variant="outline" className="absolute left-2 top-2 bg-white/80">
                {item.category_name}
              </Badge>
            )}
          </div>
              ...
              <TabsContent value="details" className="p-4">
                <div className="space-y-4">
                  ...
                  <ul className="ml-6 list-disc">
                    ...
                    {hasDiscount && (
                      <li className="text-primary">On sale for a limited time!</li>
                    )}
                  </ul>
                </div>
              </TabsContent>
              <TabsContent value="usage" className="p-4">
                <div className="space-y-4">
                  ...
                  <ol className="ml-6 list-decimal space-y-2">
                    ...
                    <li>The item will be automatically added to your account</li>
                    <li>Log in to any MCNation server to start using your new item</li>
                  </ol>
                </div>
              </TabsContent>
            </Tabs>
