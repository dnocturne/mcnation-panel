    ...
    <div className="container py-6 space-y-6">
      ...
      <Tabs defaultValue="all" className="w-full">
        ...
        <TabsContent value="succeeded" className="mt-4">
          ...
          <p className="text-muted-foreground text-center">Filter implemented in production version</p>
        </TabsContent>
...
function PaymentCard({ payment, formatCurrency, formatDate }: PaymentCardProps) {
  return (
    <Card>
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <Label className="text-muted-foreground text-xs">Minecraft Username</Label>
