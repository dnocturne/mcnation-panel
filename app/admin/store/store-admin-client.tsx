...
export function StoreAdminClient({ children }: { children: React.ReactNode }) {
  const { data: hasPermission, isLoading: permissionLoading } = usePermission('panel.webstore')
  ...
  }, [status, session, isAdminVerified, router, hasPermission, permissionLoading])
